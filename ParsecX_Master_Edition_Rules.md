...
### Phase 4: Encounter
- **Exploration:** If entering a sector with an Unknown Planet, roll 1d6. On a 4+, you discover a planet and a moon.
- **Combat:** If you occupy a sector with an opponent's ship or planet, combat occurs.
  ...
  - **Retreat:** Before rolls, a defender may discard 2 Energy to move 1 space away.
...
20. **Aggressive Terraforming:** *(Action/Upgrade)* Terraform a planet for half of the required resource cost (rounded down).
...
When purchasing an Extension, select one of the following 12 unique modules. It remains active as long as your Flagship is alive.
...
12. **Terraforming Charges:** *(Passive)* The sheer engineering power on board allows the Flagship to reshape worlds. The listed core resource cost to successfully Terraform a planet is reduced by 2 if the Flagship is in that sector.
...
4.  **Resolution:** The outcome with the highest total votes passes, and its text immediately comes into effect.
...
34. **Cultural Preservation (Elect Planet Type):** Planets of this type cannot be attacked or Terraformed.
...
10. **Terraformer:** Control 1 Terraformed Planet.
...
16. **Political Titan:** *(Requires Galactic Council)* Cast 5 or more votes during a single Agenda resolution this round.
17. **Filibuster:** *(Requires Galactic Council)* Spend exactly 3 Influence Resources during the Galactic Council Phase.
18. **Flagship Commissioning:** *(Requires Flagships)* Have an active Flagship on the board with at least 1 Extension built on its board.

**Stage 2 Public Objectives (2 VP)**

16. **Puppet Master:** *(Requires Galactic Council)* Vote "For" on an Election Agenda that successfully elects a player other than yourself.
17. **Juggernaut Pattern:** *(Requires Flagships)* Have an active Flagship on the board with 4 Extensions built on its extension board.
18. **Political Blockade:** *(Requires Both)* Successfully vote for the winning outcome of an Agenda card, AND have an active Flagship stationed on an opponent's Sector Map card simultaneously.

**Secret Objectives (1 VP)**

16. **Voice of the Senate:** *(Requires Galactic Council)* Win a Galactic Council vote where you were the only player to vote for the winning outcome.
17. **(Action Phase) Capital Ship Kill:** *(Requires Flagships)* Overwhelmingly destroy another player's Flagship during combat.
